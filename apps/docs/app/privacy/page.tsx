  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 font-sans selection:bg-zinc-900 selection:text-white">
      <div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
        <Link
          href="/"
          className="inline-flex items-center text-zinc-500 hover:text-zinc-900 font-medium transition-colors mb-8 sm:mb-12 group"
        >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="bg-white p-8 md:p-12 rounded-2xl border border-zinc-200/80 shadow-sm">
            <h1 className="text-4xl md:text-5xl font-black mb-8 text-zinc-900 tracking-tight pb-2">Privacy Policy</h1>
            ...
            <div className="text-sm leading-relaxed space-y-10 text-zinc-600">
              <p className="text-lg text-zinc-500 font-light border-l-4 border-zinc-200 pl-4 leading-relaxed">
                We respect your privacy. This policy explains what information we collect when you use the Dokugen CLI
                tool and how we use it.
              </p>
              ...
              <section>
                ...
                <p className="mb-4">
                  When you use Dokugen CLI, specifically when running commands like <code>generate</code>, we collect
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-zinc-200 bg-white">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-zinc-500 text-xs">
                          To understand our user base (Windows vs Mac vs Linux).
                        </td>
                      </tr>
                      <tr>
              ...
              <section>
                ...
                <p className="mb-4">
                  Dokugen operates local-first. While scanning repositories to build diagrams and system overviews, the
                  CLI enforces strict filters to protect sensitive information.{" "}
                  <strong>Dokugen never reads, indexes, or transmits any of the following:</strong>
                </p>
                <ul className="list-disc pl-6 space-y-2 marker:text-zinc-300">
                  <li>
                    <strong>Environment Files:</strong>{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.env</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.env.local</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.env.development</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.env.production</code>, etc.
                  </li>
                  <li>
                    <strong>Package Manager Lockfiles:</strong>{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">package-lock.json</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">pnpm-lock.yaml</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">yarn.lock</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">bun.lockb</code>
                  </li>
                  <li>
                    <strong>Local Configurations & Logs:</strong>{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">tsconfig.json</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">*.log</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">npm-debug.log</code>, etc.
                  </li>
                  <li>
                    <strong>Credentials & Secret Keys:</strong> SSL certificates, SSH keys, encryption keys, and private
                    credentials.
                  </li>
                  <li>
                    <strong>Dependencies & Build Targets:</strong> Heavy folders such as{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">node_modules</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.git</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">build</code>,{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">dist</code>, and{" "}
                    <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-xs font-mono">.next</code> are skipped
                    entirely.
                  </li>
                </ul>
              </section>
