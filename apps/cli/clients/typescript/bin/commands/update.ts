...
export function registerUpdateCommand(program: Command) {
  ...
  program
    ...
    .action(async (options: any) => {
      ...
      if (!readmeExists) {
        console.log(chalk.red("No README.md found. Use 'dokugen generate' to create one first."));
        process.exit(1);
      }
      ...
      try {
        ...
        const hasDokugenMarkers =
          existingContent.includes("<!-- DOKUGEN:") || existingContent.includes("[![Readme was generated by Dokugen]");

        if (!hasDokugenMarkers) {
          console.log(chalk.yellow("This README doesn't appear to be generated by Dokugen."));
          const proceed = await askYesNo(`Do you want to regenerate the entire ${projectName} README?`);
