  ...
  async (req: Request, res: Response): Promise<any> => {
    ...
    3. ADD THIS BADGE AT BOTTOM:
      ...
      1. **Title**:
         - ${
           noEmojis
             ? "Create a **bold and catchy title** for the project. Do not use any **emojis** in the **Title** section or any place in the Read me content. You can find the project title from maybe the meta data file of the project files (e.g package.json go.mod e.t.c) if you dont find it, then come up with a human reasonable name."
      ...
      2. **Description**:
         ...
         -${
           noEmojis
             ? "do not include a single emoji anywhere in the readme and generate a minimalist content"
      ...
      6. **Technologies Used**:
        -${
          noEmojis
            ? "Display a **table** or **grid** of only **technologies** and **descriptions**  please dont add any emojis to the readme in any place whatsoever."
      ...
      7. **Contributing**:
         ...
         -${
           noEmojis
             ? "Use **modern formatting** and do not include emojis."
      ...
      9. **Author Info**:
        -${
          noEmojis
            ? "Create a simple author section without emojis or modern formatting, with social media links except for a GitHub link."
     ...
     - If the project is **modern**, ${
       noEmojis
         ? "do not include a single emoji anywhere in the readme and generate a minimalist content"
         : "use **eye-catching elements** like emojis, but not too much ooo! please let the readme be matured not packed with unnecessary emojis!!!, badges, and creative formatting."
     }
