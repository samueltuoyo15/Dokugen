...
const PopBurst = ({ x, y, start, color = palette.yellow }: { x: number; y: number; start: number; color?: string }) => {
  ...
  const fade = interpolate(frame, [start + 5, start + 16], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  return (
      ...
      <AbsoluteFill style={{ backgroundColor: palette.ink, padding: "96px 68px 74px", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <Message delay={46} mine>
            I need it to look proper before other developers and recruiters see it.
          </Message>
          <Message delay={78}>
            Use <span style={{ fontFamily: mono, color: palette.yellow }}>https://dokugen.samueltuoyo.com</span>. It
            reads the repo, then gives you a README worth showing.
          </Message>
        </div>
      ...
      >
        ...
        <div
          style={{
            ...
            marginTop: 154,
            opacity: p,
            transform: `translateY(${(1 - p) * 80}px) rotate(${(1 - p) * -2}deg)`,
            overflow: "hidden",
          }}
        >
          <Video
    ...
    <Scene duration={105}>
      <AbsoluteFill style={{ backgroundColor: palette.ink, padding: "110px 70px", boxSizing: "border-box" }}>
        ...
        <div style={{ marginTop: 58, opacity: p, transform: `translateY(${(1 - p) * 50}px)` }}>
          ...
          >
            <Img
              src={staticFile("evidence/github-blank-readme.png")}
...
const TerminalRow = ({
  ...
  delay,
  color = palette.cream,
}: { children: ReactNode; delay: number; color?: string }) => {
  const frame = useCurrentFrame();
  ...
  return (
    <Scene duration={155}>
      <AbsoluteFill style={{ backgroundColor: palette.charcoal, padding: "102px 66px", boxSizing: "border-box" }}>
        ...
        >
          <TerminalRow delay={0} color={palette.muted}>
            PS &gt; <span style={{ color: palette.yellow }}>{typed}</span>
            <span style={{ opacity: frame % 14 < 7 ? 1 : 0 }}>_</span>
          </TerminalRow>
          <div style={{ height: 30 }} />
          <TerminalRow delay={30} color={palette.muted}>
            [2026-07-18] Current README backed up in memory
          </TerminalRow>
          <TerminalRow delay={36}>
            <span style={{ color: palette.green }}>✔</span> Found: 15 files in the project
          </TerminalRow>
          <TerminalRow delay={42}>
            Detected project type: <span style={{ color: palette.yellow }}>Go</span>
          </TerminalRow>
          <TerminalRow delay={50}>README.md exists for SaveIt. Overwrite?</TerminalRow>
          <TerminalRow delay={56} color={palette.green}>
            {" "}
            Yes
          </TerminalRow>
          <TerminalRow delay={64} color={palette.muted}>
            Analyzing project files...
          </TerminalRow>
          <TerminalRow delay={72}>Include setup instructions in the README?</TerminalRow>
          <TerminalRow delay={78} color={palette.green}>
            {" "}
            Yes
          </TerminalRow>
          <TerminalRow delay={84}>Include contribution guidelines in README?</TerminalRow>
          <TerminalRow delay={90} color={palette.green}>
            {" "}
            Yes
          </TerminalRow>
          <TerminalRow delay={96}>Include API documentation in README?</TerminalRow>
          <TerminalRow delay={102} color={palette.green}>
            {" "}
            Yes
          </TerminalRow>
          <TerminalRow delay={108}>Include system design diagrams in README?</TerminalRow>
          <TerminalRow delay={114} color={palette.green}>
            {" "}
            Yes
          </TerminalRow>
          <TerminalRow delay={120}>
            LinkedIn username: <span style={{ color: palette.green }}>Use saved details (@samueltuoyo)</span>
          </TerminalRow>
          <TerminalRow delay={126}>
          ...
          <TerminalRow delay={132} color={palette.green}>
            ✔ README.md created successfully in 27s
          </TerminalRow>
        </div>
    ...
    <Scene duration={840}>
      <AbsoluteFill
        style={{
          backgroundColor: palette.yellow,
          backgroundImage:
            "radial-gradient(ellipse at 8% 90%, #050505 0%, #171612 29%, rgba(23,22,18,0.68) 43%, transparent 67%), linear-gradient(150deg, #ffd94c 0%, #f3c83b 57%, #151512 100%)",
          padding: "84px 0",
          boxSizing: "border-box",
          alignItems: "center",
        }}
      >
        <div style={{ position: "absolute", top: 78, left: 68, zIndex: 2 }}>
          <ProgressMark
            color={palette.ink}
            label="Here is the kind of README/documentation Dokugen can create for your project."
          />
        </div>
        <div
          style={{
    ...
    <Scene duration={150}>
      <AbsoluteFill style={{ backgroundColor: palette.ink, padding: "102px 66px", boxSizing: "border-box" }}>
        ...
        >
          ...
          <div style={{ height: 28 }} />
          <TerminalRow delay={34} color={palette.muted}>
            No staged changes detected. Staging all files...
          </TerminalRow>
          <TerminalRow delay={46}>Files being committed:</TerminalRow>
          <TerminalRow delay={54} color={palette.muted}>
            {" "}
            cmd/server/main.go
          </TerminalRow>
          <TerminalRow delay={60} color={palette.muted}>
            {" "}
            public/robots.txt
          </TerminalRow>
          <TerminalRow delay={66} color={palette.muted}>
            {" "}
            public/sitemap.xml
          </TerminalRow>
          <TerminalRow delay={72} color={palette.muted}>
            {" "}
            templates/index.html
          </TerminalRow>
          <div style={{ height: 14 }} />
          <TerminalRow delay={82} color={palette.green}>
            ✔ Commit message generated successfully in 4s
          </TerminalRow>
          <div
            style={{
              marginTop: 26,
              ...
              lineHeight: 1.45,
              color: palette.paper,
              opacity: ease(frame, 96, 10),
            }}
          >
            feat(server): add sitemap, robots.txt,
            <br />
            and public assets while restricting index.html
          </div>
          <TerminalRow delay={112}>What would you like to do?</TerminalRow>
          <TerminalRow delay={118} color={palette.yellow}>
            {" "}
            Accept and Commit
          </TerminalRow>
          <TerminalRow delay={126} color={palette.muted}>
            [main 3a243ce] feat(server): add sitemap, robots.txt...
          </TerminalRow>
          <TerminalRow delay={134} color={palette.green}>
            Commit successful
          </TerminalRow>
        </div>
    ...
    <Scene duration={90}>
      ...
      >
        <div style={{ opacity: p, transform: `translateY(${(1 - p) * 42}px)` }}>
          ...
          >
            The README/documentation part people skip,
            <br />
            handled properly.
          </div>
        </div>
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: palette.ink }}>
      <Audio
        ...
        volume={(frame) =>
          interpolate(frame, [0, fps, 27 * fps, 30 * fps], [0, 0.2, 0.2, 0], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
          })
        }
      ...
      <Sequence from={135} durationInFrames={330}>
        <WebsiteScene />
      </Sequence>
      ...
      <Sequence from={680} durationInFrames={840}>
        <ProofScene />
      </Sequence>
      <Sequence from={1505} durationInFrames={150}>
        <AicScene />
      </Sequence>
      <Sequence from={1640} durationInFrames={90}>
        <FinalScene />
      </Sequence>
